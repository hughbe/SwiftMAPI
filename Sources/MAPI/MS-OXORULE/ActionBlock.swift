...
public struct ActionBlock {
    ...
    public struct MoveCopyActionDataExtended {
        ...
        public init(dataStream: inout DataStream) throws {
            ...
            self.folderEID = try FolderEntryID(dataStream: &dataStream, size: Int(self.folderEIDSize))
        }
    }
    ...
    public struct ReplyOOFReplyActionDataStandard {
        ...
        public let replyTemplateGUID: GUID
        ...
        public init(dataStream: inout DataStream) throws {
            ...
            self.replyTemplateGUID = try GUID(dataStream: &dataStream)
        }
    }
    ...
    public struct ReplyOOFReplyActionDataExtended {
        ...
        public init(dataStream: inout DataStream) throws {
            ...
            /// ReplyTemplateMessageEID (70 bytes): A Message EntryID structure, as specified in [MSOXCDATA] section 2.2.4.2, that contains the entry
            /// ID of the reply template.
            self.replyTemplateMessageEID = try MessageEntryID(dataStream: &dataStream, size: Int(messageEIDSize))
